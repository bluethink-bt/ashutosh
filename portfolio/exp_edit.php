        ...
        <div class="page-wrapper">
            <div class="content container-fluid">
                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-md-6">
                            <h3 class="page-title mb-0">Expence List</h3>
                        </div>
                        <div class="col-md-6">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                            <form method="POST" action="backend/exp_type_edit_backed.php">
                                            <?php
                                                    require('config.php');
                                                        $sql = "SELECT * from exp_type where id= $id ";
                                              ...
                                              ?>
                                               <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <label>Edit The exp Type </label>
                                                    <input type="text" class="form-control" name="exp_type" value="<?php echo $data['exp_type']; ?>">
                                                </div>
                                                                ...
                                                                <table class="table custom-table">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        ?>
                                                                            <tr>
                                                                                <td>
                                                                                    <a href="" class="avatar bg-green"><?php echo $serila ?></a>
                                                                                </td>
                                                                                <td><?php echo $data['exp_type']; ?></td>
                                                                                

                                                                                <td class="text-right">
                                                                                    <a href="exp_edit.php?id=<?php echo $data['id']; ?>" class="btn btn-primary btn-sm mb-1">
                                                                                        <i class="far fa-edit"></i>
                                                                                    </a>
                                                                                    <button type="submit" data-toggle="modal" data-target="#delete_employee" class="btn btn-danger btn-sm mb-1">
                                                                                    <a href="backend/exp_delete.php?id=<?php echo $data['id']; ?>" >
