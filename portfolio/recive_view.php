                                        ...
                                        <div class="table-responsive">
                                            <table class="table custom-table">
                                                ...
                                                <tbody>
                                                    ...
                                                    require('config.php');
                                                    if ($month1 == "All") {
                                                        $sql = "SELECT * from creadit  limit $offset ,$limit ";

                                                        $sql_offset= "SELECT * from creadit ";
                                                        ...
                                                        $sql = "SELECT * from creadit WHERE month = '$month1' limit $offset ,$limit ";

                                                        $sql_offset = "SELECT * from creadit WHERE month = '$month1' ";
                                                        $result_offset = mysqli_query($conn, $sql_offset);
                                                        if (mysqli_num_rows($result_offset) > 0) {
                                                            $count_record = mysqli_num_rows($result_offset);
                                                            $total_page = ceil($count_record / $limit);
